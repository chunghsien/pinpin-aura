<header class="header header-box-topbar header-sticky header-transparent-background">
 <!-- header bottom -->
  ...
  <div class="container wide">
   ...
   <div class="header-bottom-container">
    ...
    <div class="language-currency-change-container">
     ...
     <!-- header separator -->
     <span class="header-separator d-none d-lg-block">
      |
     </span>
    ...
    <div class="logo-with-offcanvas">
     ...
     <div class="logo">
      <a href="index.html">
       <img alt="" class="img-fluid" src="assets/images/logo-alt.png"/>
       ...
       <ul>
        <li class="menu-item-has-children">
         ...
         <ul class="sub-menu mega-menu mega-menu-column-5">
          <li>
           <a class="mega-column-title" href="javascript:void(0)">
            Home Group
           </a>
           <ul class="mega-sub-menu">
            <li>
             <a href="index-trending.html">
              Trending
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/01.jpg"/>
            </li>
            <li>
             <a href="index-collection.html">
              My collection
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/02.jpg"/>
            </li>
            <li>
             <a href="index-special.html">
              Special
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/03.jpg"/>
            </li>
            <li>
             <a href="index-concept.html">
              concept
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/04.jpg"/>
            </li>
            <li>
             <a href="index-smart.html">
              smart design
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/05.jpg"/>
            </li>
           </ul>
          </li>
          <li>
           ...
           <ul class="mega-sub-menu">
            <li>
             ...
             <img alt="" class="img-fluid" src="assets/images/home-preview/06.jpg"/>
            </li>
            <li>
             <a href="index-essentials.html">
              Essentials
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/07.jpg"/>
            </li>
            <li>
             <a href="index-lookbook.html">
              Lookbook
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/08.jpg"/>
            </li>
            <li>
             <a href="index-wearables.html">
              Wearables
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/09.jpg"/>
            </li>
            <li>
             <a href="index-accessories.html">
              Accessories
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/10.jpg"/>
            </li>
           </ul>
          </li>
          <li>
           ...
           <ul class="mega-sub-menu">
            <li>
             <a href="index-shoppable.html">
              Shoppable
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/11.jpg"/>
            </li>
            <li>
             <a href="index-fashion.html">
              Fashion
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/13.jpg"/>
            </li>
            <li>
             <a href="index-perfumes.html">
              Perfumes
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/14.jpg"/>
            </li>
            <li>
             <a href="index-cosmetics.html">
              Cosmetics
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/15.jpg"/>
            </li>
            <li>
             <a href="index-decor.html">
              Home Decor
             </a>
             <img alt="" class="img-fluid" src="assets/images/home-preview/16.png"/>
            </li>
           </ul>
          </li>
          <li>
           ...
           <ul class="mega-sub-menu">
            <li>
             ...
             <img alt="" class="img-fluid" src="assets/images/home-preview/17.png"/>
            </li>
           </ul>
          </li>
          <li>
           <div class="menu-image">
            <img alt="" class="img-fluid" src="assets/images/menu-image/menu-element.png"/>
           </div>
          </li>
         </ul>
        </li>
        <li class="menu-item-has-children">
         ...
         <ul class="sub-menu mega-menu mega-menu-column-4">
          ...
          <li>
           <div class="menu-image">
            <img alt="" class="img-fluid" src="assets/images/menu-image/megamenu-shop.png"/>
           </div>
          </li>
         </ul>
        </li>
        <li class="menu-item-has-children">
         ...
         <ul class="sub-menu mega-menu mega-menu-column-5">
          ...
          <li>
           ...
           <ul class="mega-sub-menu">
            <li>
             <a href="element-blog-posts.html">
              Blog Posts
             </a>
            </li>
            <li>
